...
import { alertDialog } from "./index.recipe";
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Cancel ref={ref} className={cx(button({ variant: "outline" }), className)} {...props} />
));
...
export const AlertDialogDescription = withContext(styled(AlertDialogPrimitive.Description), "description");
