...
import { styled, cx, HStack } from "@atdb/design-system";
import { navigationMenu } from "./index.recipe";
...
>(({ children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger ref={ref} {...props}>
    <HStack>{children}</HStack> <ChevronDown aria-hidden="true" />
...
export const NavigationMenuIndicator = withContext(styled(NavigationMenuPrimitive.Indicator), "indicator", { children: <div /> });
